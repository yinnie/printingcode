...
void createGrid() {
    ...
    for ( int i = 0; i < cols; i++) {
      for ( int j = 0; j < rows; j++) {
        ...
        //randomize the spacing of the elements in the grid a little so that 
        //the shapes read like letters with natural spacings..
        float rndmspacing = random(-10,10);
        nodes[n] = new Node ( marginw + i*w + rndmspacing, marginh + j*h);
        n++;
      }
    }
  }
